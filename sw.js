const CACHE='scorer-v0.3.1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./sports.js','./journal.js','./enhancements.js','./v031-core.js','./v031.js','./manifest.webmanifest','./assets/app-icon.svg'];
