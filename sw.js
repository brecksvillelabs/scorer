const CACHE='scorer-v0.3.2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./sports.js','./journal.js','./enhancements.js','./v031-core.js','./v031.js','./v032-core.js','./v032.js','./manifest.webmanifest','./assets/app-icon.svg'];
