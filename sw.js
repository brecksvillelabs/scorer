const CACHE='scorer-v0.3.4';
const ASSETS=['./','./index.html','./styles.css','./app.js','./sports.js','./journal.js','./enhancements.js','./v031-core.js','./v031.js','./v032-core.js','./v032.js','./v033.js','./v034-core.js','./v034.js','./v034-guard.js','./manifest.webmanifest','./assets/app-icon.svg'];
